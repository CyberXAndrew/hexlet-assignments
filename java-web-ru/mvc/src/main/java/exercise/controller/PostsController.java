...
public class PostsController {
    ...
    public static void edit(Context ctx) {
        ...
        if (post != null) {
            ...
            var name = postPage.getPost().getName();
            var body = postPage.getPost().getBody();
    ...
    public static void update(Context ctx) {
        ...
        try {
            ...
            Post changeablePost = PostRepository.find(id);
            changeablePost.setName(name);
            changeablePost.setBody(body);
            ctx.redirect(NamedRoutes.postsPath());
        } catch (ValidationException e) {
